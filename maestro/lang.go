...
var translations = map[Lang]map[string]string{
	LangPt: {
		...
		"help_study":       "  /study <ativo> [tf] - Inicia simulação com prints (não abre ordem).",
		...
		"help_fix":         "  /fix              - Conserta (reinicia) robôs que entraram em Crash Loop.",
	...
	LangEn: {
		...
		"help_study":       "  /study <symbol> [tf] - Starts simulation (Study Mode, no real orders).",
		...
		"help_fix":         "  /fix              - Repairs (restarts) crashed workers.",
	...
	LangEs: {
		...
		"help_study":       "  /study <simbolo> [tf] - Inicia simulación (Study Mode, sin órdenes).",
		"help_stop":        "  /stop <simbolo>     - Detiene la operacion en un simbolo.",
		"help_list":        "  /list             - Lista los simbolos operando actualmente.",
		...
		"help_fix":         "  /fix              - Repara (reinicia) workers colgados.",
