...
def test_register_external_position_records_manual(monkeypatch):
    import MetaTrader5 as mt5
    from brain.execution_manager import _register_external_position
...
def test_reconcile_closed_trade_record_exit(monkeypatch):
    import MetaTrader5 as mt5
    from brain.execution_manager import _register_external_position, _reconcile_closed_trades
